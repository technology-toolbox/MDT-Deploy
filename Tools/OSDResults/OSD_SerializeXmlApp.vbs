'\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
'\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
'\\\\\\\\\\\\\\\\OSD Clear Selected applications\\\\\\\\\\\\\\\\\\\\\\
'\\\\\\\\\\\\\\\\\\\\\\\\\\in app file\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
'\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
'\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
Option Explicit

Dim FSO, strContents, oFile
Dim oTSE
...
Dim xmlFile : xmlFile = oTSE("ApplicationFile")

if(len(xmlFile) > 0 and FSO.FileExists(xmlFile)) Then
    Set oFile = FSO.OpenTextFile(xmlFile, 1)
    strContents = oFile.ReadAll
    oFile.Close
    oTSE("ApplicationList") = strContents
    Wscript.Echo "Finished seralizing file " & xmlFile
else
    if(len(xmlFile) > 0) Then
            Wscript.Echo "File is empty: " & xmlFile
    else
        Wscript.Echo "File does not exists: " & xmlFile
    End if
end if
...
'' SIG '' AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFLs+8g9keudU
'' SIG '' cBxRk55Zq9XY8Y3JoIIVNjCCBKkwggORoAMCAQICEzMA
...
'' SIG '' IwYJKoZIhvcNAQkEMRYEFNKMj9m2762XNiDJrQiuJ8ts
'' SIG '' VmjdMFIGCisGAQQBgjcCAQwxRDBCoCSAIgBNAEQAVAAg
'' SIG '' AFUARABJAHYAMwAgAFQAbwBvAGwAawBpAHShGoAYaHR0
'' SIG '' cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
'' SIG '' AQUABIIBAD/RUjloC9auy4jBaeEC9DrDLcZyDnYGp6uA
'' SIG '' KCKC+1fcL9G7iQ/wAdxCIR0bt5uj2XxenuqwMpL5/zqu
'' SIG '' fjRg9dnazcQIlSJr1pTeVgdFaA4ijWZwuuDr9cxBgpoa
'' SIG '' Bjtd+Mq1s9dVjqDWlPwXzoT7tZPAcSnn9mN0b8GhkgRT
'' SIG '' 2zK1d1/C2QW7FXr3GjgR+eOJvL0KXy5HAnNQ4KbrJJMU
'' SIG '' AWlom+WR2h8o5qGKYMJ933sIfakI7qCR3LYiwOPVrkrz
'' SIG '' TcMZL/qETxAWyq4o8iCzmtf5sph20rcW/JDcszIRyZX5
'' SIG '' jSn2thZzhsCDk/DA/5DXKryYUNO/Z6n5KiUgXct0d8Sh
...
'' SIG '' MDJaMCMGCSqGSIb3DQEJBDEWBBS4eWwPN3JUYyIop01o
'' SIG '' SAMrI7KrUDANBgkqhkiG9w0BAQUFAASCAQBmMqdtJoyH
'' SIG '' xnuEAtVAy2VBAT55thPvo9iWUPE6pK2U5V3Im+wbQHYW
'' SIG '' RUw9qqAzPYKG/j/35ogQ991/93p0FXC9eZgNInZQOwtx
'' SIG '' 214Ob88ynupQhwy7MuQ2h/QbgjsdTkFH+YyF64CeihLk
'' SIG '' yKW4IVnFFCENnTdsdxDlNI+Oyi5ZkCiJvmfC9vlFoxD4
'' SIG '' Y5sNtvzoY03EPcUgrN/Co88UesQpM2QhQIYZbc+1xkNN
'' SIG '' GOuhvSH0idWHpoO2Qvl51O1PyVYriW3PNiQ302wCeNjv
'' SIG '' f24CoDBAEqXyoP4Fw9ok8AcTSZNwW+A+18MyVS154WDh
'' SIG '' jpZcd65H/PXlUP2gi+0Zmote
